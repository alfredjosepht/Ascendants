            ...
            <form action={formAction} className="space-y-4">
              <div>
                ...
                <Textarea
                  ...
                  placeholder="e.g., 'I am a computer science student interested in learning about cloud computing, specifically AWS and serverless architectures. I'm also keen on product management.'"
                  rows={6}
                  required
                />
